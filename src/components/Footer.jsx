  ...
  <footer className="bg-primary text-white py-4 mt-12">
    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      <div className="mb-4 md:mb-0">
        <p className="font-semibold">Imagen hibrida, Santa Cruz de la Sierra, Bolivia</p>
        <p className="text-gray-200">+591-750-06874 &nbsp;|&nbsp; dr.bowles-gerentemedico@dimm-bolivia.com</p>
      </div>
      ...
      <a href="https://www.instagram.com/imagenhibrida_/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
        ...
        <a href="https://wa.me/59175006874" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="text-center text-gray-200 mt-4 text-sm">
      © {new Date().getFullYear()} Dr. Hans Bowles | Todos los derechos reservados
    </div>
  </footer>
);
